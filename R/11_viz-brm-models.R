...
# 
# conditional_effects(brm_mods_list[["brm_mods_1"]][[1]],"log_mass:Alpha_mode", int_conditions = int_conditions)
# conditional_effects(brm_mods_list_asym[["brm_mods_1_asym"]][[1]],"TP_mode:Alpha_mode", int_conditions = int_conditions)
...
# conditional_effects(brm_mods_list[["brm_mods_2b_p4"]][[1]],"log_mass:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list_asym[["brm_mods_2b_p4_asym"]][[1]],"TP_mode:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_s2"]][[1]],"log_mass:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list_asym[["brm_mods_2b_s2_asym"]][[1]],"TP_mode:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
...
# conditional_effects(brm_mods_list[["brm_mods_3b_p5"]][[1]],"log_mass:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list_asym[["brm_mods_3b_p5_asym"]][[1]],"TP_mode:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_s4"]][[1]],"log_mass:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
# conditional_effects(brm_mods_list_asym[["brm_mods_3b_s4_asym"]][[1]],"TP_mode:Alpha_mode", int_conditions = int_conditions, re_formula = NULL)
...
plot_mods_asym <- list(
  brm_mods_list_asym[["brm_mods_1_asym"]][[1]], 
  brm_mods_list_asym[["brm_mods_2a_s1_asym"]][[1]], 
  brm_mods_list_asym[["brm_mods_2a_p2_asym"]][[1]], 
  brm_mods_list_asym[["brm_mods_2b_s2_asym"]][[1]],
  brm_mods_list_asym[["brm_mods_2b_p4_asym"]][[1]],
  brm_mods_list_asym[["brm_mods_3a_s3_asym"]][[1]], 
  brm_mods_list_asym[["brm_mods_3a_p3_asym"]][[1]], 
  brm_mods_list_asym[["brm_mods_3b_s4_asym"]][[1]],
  brm_mods_list_asym[["brm_mods_3b_p5_asym"]][[1]]
)

plot_data_list <- list(
  reg_mod_data_tidy[["p1"]], 
  reg_mod_data_tidy[["s1"]], 
  reg_mod_data_tidy[["p2"]], 
  reg_mod_data_tidy[["s2"]], 
  reg_mod_data_tidy[["p4"]], 
  reg_mod_data_tidy[["s3"]], 
  reg_mod_data_tidy[["p3"]], 
...
names(plots_asym) <- c(
  ...
  "asym_2b_s2_region", 
  "asym_2b_p4_region", 
  "asym_3a_s3_basinXseason", 
  "asym_3a_p3_basinXseason", 
...
### Quick plots ----------
# conditional_effects(brm_mods_list[["brm_mods_1"]][[4]])
# conditional_effects(brm_mods_list[["brm_mods_2a_p2"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2a_s1"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_p4"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_s2"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3a_p3"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3a_s3"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_p5"]][[6]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_s4"]][[6]], re_formula = NULL)
...
# conditional_effects(brm_mods_list[["brm_mods_2a_ind"]][[1]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_ind"]][[1]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3a_ind"]][[1]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_ind"]][[1]], re_formula = NULL)
...
plot_mods_alpha_tp_ind <- list(
  ...
  brm_mods_list[["brm_mods_2a_s1_ind"]][[1]], 
  brm_mods_list[["brm_mods_2a_p2_ind"]][[1]], 
  brm_mods_list[["brm_mods_2b_s2_ind"]][[1]], 
  brm_mods_list[["brm_mods_2b_p4_ind"]][[1]], 
  brm_mods_list[["brm_mods_3a_s3_ind"]][[1]], 
  brm_mods_list[["brm_mods_3a_p3_ind"]][[1]], 
...
plot_data_list_ind <- list(
  ...
  reg_mod_data_tidy[["s1_id"]], 
  reg_mod_data_tidy[["p2_id"]], 
  reg_mod_data_tidy[["s2_id"]], 
  reg_mod_data_tidy[["p4_id"]], 
  reg_mod_data_tidy[["s3_id"]], 
  reg_mod_data_tidy[["p3_id"]], 
...
names(plots_alpha_tp_ind) <- c(
  ...
  "alpha_maass_ind_2a_s1_basin", 
  "alpha_maass_ind_2a_p2_basin", 
  "alpha_maass_ind_2b_s2_region", 
  "alpha_maass_ind_2b_p4_region", 
  "alpha_maass_ind_3a_s3_basinXseason", 
  "alpha_maass_ind_3a_p3_basinXseason", 
...
### Quick plots -----------------
# conditional_effects(brm_mods_list[["brm_mods_1"]][[7]])
# conditional_effects(brm_mods_list[["brm_mods_2a_p2"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2a_s1"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_p4"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_2b_s2"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3a_p3"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3a_s3"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_p5"]][[11]], re_formula = NULL)
# conditional_effects(brm_mods_list[["brm_mods_3b_s4"]][[11]], re_formula = NULL)
...
names(plots_alpha_mass) <- c(
  "alpha_mass_1_pooled", 
  "alpha_mass_2a_s1_basin", 
  "alpha_mass_2a_p2_basin", 
  "alpha_mass_2b_s2_region", 
  "alpha_mass_2b_p4_region", 
  "alpha_mass_3a_s3_basinXseason", 
  "alpha_mass_3a_p3_basinXseason", 
...
p1 <- ((plots_asym[[1]] | plots_alpha_mass[[1]]) / (plots_alpha_tp[[1]] | plots_alpha_tp_ind[[1]])) + 
  plot_annotation(title = "Scale 1: pooled baseline", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p2 <- ((plots_asym[[2]] | plots_alpha_mass[[2]]) / (plots_alpha_tp[[2]] | plots_alpha_tp_ind[[2]])) + 
  plot_annotation(title = "Scale 2a: tp & alpha by lake basin (north vs. south)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p3 <- ((plots_asym[[3]] | plots_alpha_mass[[3]]) / (plots_alpha_tp[[3]] | plots_alpha_tp_ind[[3]])) + 
  plot_annotation(title = "Scale 2a: pooled baseline, tp & alpha by lake basin (north vs. south)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p4 <- ((plots_asym[[4]] | plots_alpha_mass[[4]]) / (plots_alpha_tp[[4]] | plots_alpha_tp_ind[[4]])) + 
  plot_annotation(title = "Scale 2b: tp & alpha by lake region (NW, NE, SW, SE)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p5 <- ((plots_asym[[5]] | plots_alpha_mass[[5]]) / (plots_alpha_tp[[5]] | plots_alpha_tp_ind[[5]])) + 
  plot_annotation(title = "Scale 2b: pooled baseline, tp & alpha by lake region (NW, NE, SW, SE)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p6 <- ((plots_asym[[6]] | plots_alpha_mass[[6]]) / (plots_alpha_tp[[6]] | plots_alpha_tp_ind[[6]])) + 
  plot_annotation(title = "Scale 3a: tp & alpha by basin (N, S) and season (spring, summer, fall)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p7 <- ((plots_asym[[7]] | plots_alpha_mass[[7]]) / (plots_alpha_tp[[7]] | plots_alpha_tp_ind[[7]])) + 
  plot_annotation(title = "Scale 3a: pooled baseline, tp & alpha by basin (N, S) and season (spring, summer, fall)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p8 <- ((plots_asym[[8]] | plots_alpha_mass[[8]]) / (plots_alpha_tp[[8]] | plots_alpha_tp_ind[[8]])) + 
  plot_annotation(title = "Scale 3b: tp & alpha by region (NW, NE, SW, SE) and season (spring, summer, fall)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

p9 <- ((plots_asym[[9]] | plots_alpha_mass[[9]]) / (plots_alpha_tp[[9]] | plots_alpha_tp_ind[[9]])) + 
  plot_annotation(title = "Scale 3b: pooled baseline, tp & alpha by region (NW, NE, SW, SE) and season (spring, summer, fall)", 
                  tag_levels = "a", tag_prefix = "(", tag_suffix = ")")


# List plots, name, and save to file
panel_plots <- list(p1, p2, p3, p4, p5, p6, p7, p8, p9)
names(panel_plots) <- c(
  "results_1_pooled", 
  "results_2a_s1_basin", 
  "results_2a_p2_basin", 
  ...
  "results_3a_s3_basinXseason", 
  "results_3a_p3_basinXseason", 
...
pwalk(list(paths, panel_plots), ggsave, 
      path = here("out", "plots"),
      height = 18, width = 20, units = "cm", device = png)


# p10 <- ( 
#   (plots_asym[[8]] / plots_alpha_mass[[8]] / plots_alpha_tp[[8]] / plot_spacer()) |
#     (plots_asym[[9]] / plots_alpha_mass[[9]] / plots_alpha_tp[[9]] / plot_spacer()) 
#   ) + 
#   plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")")
# 
# ggsave(here("out","plots","results_scale03_long"), p10, height = 20, width = 14, units = "cm", device = png)

p11 <- ( 
  (plots_asym[[8]] | plots_alpha_mass[[8]] | plots_alpha_tp[[8]] | plots_alpha_tp_ind[[8]]) /
    (plots_asym[[9]] | plots_alpha_mass[[9]] | plots_alpha_tp[[9]] | plots_alpha_tp_ind[[9]]) 
) + 
  plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")")

ggsave(here("out","plots","result_scale3_wide"), p11, height = 9, width = 18, units = "cm", device = png)
